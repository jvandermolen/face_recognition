...
if __name__ == '__main__':
    ...
    args = dict(args)
    cascade_fn = args.get('--cascade', "/shared/videos/haarcascades/haarcascade_frontalface_alt.xml")
    nested_fn  = args.get('--nested-cascade', "/shared/videos/haarcascades/haarcascade_eye.xml")
    cascade2_fn = args.get('--cascade2', "/shared/videos/haarcascades/haarcascade_profileface.xml")
    cascade3_fn = args.get('--cascade3', "/shared/videos/haarcascades/haarcascade_frontalface_alt2.xml")
    cascade4_fn = args.get('--cascade4', "/shared/videos/haarcascades/haarcascade_frontalface_alt_tree.xml")
